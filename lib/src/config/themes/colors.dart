part of 'package:hamidjalili_resume_web/src/config/themes/app_themes.dart';

const kPrimaryColor = Color(0xff6E39DF);
...
const kBackgroundColor = Color(0xff1C1F24);
const kOnBackgroundColor = Color(0xff272A2F);
