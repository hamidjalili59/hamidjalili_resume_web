...
/// kBottomSheetBorderRadius = 20
const double kBottomSheetBorderRadius = 20;
const String kFont = 'Morabbae';
const String baseUrl = 'https://gogogogog.com/';
const String wordsUrl = 'https://hamid.storage.iran.liara.space/words.json';
...
const  touriperColor = Color(0xff000090);
const  cartamColor = Colors.blue;
const  quranColor = Color.fromARGB(255, 120, 97, 177);
